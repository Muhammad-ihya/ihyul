...
if menu == "Penjelasan Gula":
    st.header("Apa itu Gula?")
    st.write("""
        Gula adalah jenis karbohidrat sederhana yang memberikan rasa manis pada makanan dan minuman. 
        Gula dapat ditemukan secara alami dalam banyak makanan, seperti buah-buahan dan susu. 
        Selain itu, gula juga dapat ditambahkan ke makanan dan minuman sebagai pemanis.
        
        Terdapat beberapa jenis gula, termasuk:
        - **Sukrosa**: Gula meja yang umum digunakan.
        - **Fruktosa**: Gula yang terdapat dalam buah-buahan.
        - **Glukosa**: Sumber energi utama bagi tubuh.

        Meskipun gula memberikan energi, konsumsi berlebihan dapat menyebabkan masalah kesehatan seperti obesitas, diabetes, dan penyakit jantung. Oleh karena itu, penting untuk mengatur asupan gula dalam diet sehari-hari.
    """)

# Kalkulator Kebutuhan Gula
elif menu == "Kalkulator Kebutuhan Gula":
    st.write("you have entered", st.session_state.get("my_input", ""))
