...
# Fungsi untuk menambahkan background gambar dengan overlay hitam
...
add_gradient_overlay_background(image_url=image_url)

# Tambahkan CSS kustom untuk mengatur warna judul
add_custom_css()
...
def hitung_kebutuhan_gula(usia , berat_badan):
    # Asumsi kebutuhan gula (contoh: 10% dari kalori harian)
